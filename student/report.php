  ...
  <div class="form-group">
   ...
   <?php
    ...
    //initializing ID 
     ...
     $all_query = mysqli_query($connection,"select stat_id,count(*) as countP from attendance where attendance.stat_id='$sr_id' and attendance.course = '$course' and attendance.st_status='Present'");
