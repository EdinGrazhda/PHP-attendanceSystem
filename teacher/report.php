  ...
  <div class="content">
   ...
   <?php
    ...
    if(isset($_POST['sr_btn'])){
     ...
     $single = mysqli_query($connection,"select stat_id,count(*) as countP from attendance where attendance.stat_id='$sr_id' and attendance.course = '$course' and attendance.st_status='Present'");
      $singleT= mysqli_query($connection,"select count(*) as countT from attendance where attendance.stat_id='$sr_id' and attendance.course = '$course'");
    ...
    if(isset($_POST['sr_date'])){
     ...
     $all_query = mysqli_query($connection,"select * from attendance where attendance.stat_date='$sdate' and attendance.course = '$course'");
